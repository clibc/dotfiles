;;; esh-theme-theme.el --- Theme 

;; Copyright (C) 2021 , shigi
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'esh-theme
	...
	`(font-lock-constant-face ((,class (:foreground ,const))))
        ...
        `(region ((,class (:background ,hl-line :foreground ,fg1))))
        `(highlight ((,class (:foreground ,fg3 :background ,bg3))))
	`(hl-line ((,class (:background  ,"#072727"))))
...
(provide-theme 'esh-theme)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; esh-theme-theme.el ends here
